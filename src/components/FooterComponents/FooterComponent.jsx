        ...
        <Row className="d-flex justify-content-between">
          <Col lg="5">
            ...
            <p className="desc">
              ...
              Laboriosam ullam voluptatum ab iste vero ipsam possimus libero
              accusantium nulla dolor!
            </p>
            <div className="no mb-1 mt-4">
              <Link className="text-decoration-none">
                <i className="fa-brands fa-whatsapp"></i>
                <p className="m-0">+62 123-2456-8912</p>
              </Link>
            </div>
            <div className="mail">
              <Link className="text-decoration-none">
        ...
        <Row>
          <Col>
            <p className="text-center px-md-0 px-3">
              ...
              <span className="fw-bold"> Sufyan Alvaro,</span> All Right
              Reserved
            </p>
          </Col>
        </Row>
